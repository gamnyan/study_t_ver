...
<body>
				...
				<c:forEach var="customer" items="${customerList}">
					<tr>
						<td><a class="customer_id"
							href="<c:url value="orderingControl?action=customer&id=${customer.id}"/>"
							data-id="${customer.id}">${customer.id}</a></td>
						<td>${customer.name}</td>
	...
	<div class="container">
		<form id="goto_form" action="<c:url value="orderingControl"/>"
			method="get">
	...
	<script src="exOrdering/customers.js"></script>
</body>
</html>