...
function cardChange(event) {
    ...
    try {
        ...
        let sumMinusDiscount = $('#price_discount').val(); //
...
function sumDiscountPrice(){
	let sumDiscountPrice = priceSum-sumMinusDiscount;
	$('#sum_discount_price').innerText(sumDiscountPrice);
}
